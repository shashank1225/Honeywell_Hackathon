...
class SafetySentinel:
    ...
    def validate(
        ...
        *,
        ...
        reverses_a_recent_change = self._reverses_recent_change(temperature_delta, ventilation_delta)
        if (
    ...
    def _reverses_recent_change(self, temperature_delta: float, ventilation_delta: float) -> bool:
        ...
        return temperature_reversal or ventilation_reversal
